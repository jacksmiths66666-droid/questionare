...
OUT = BASE / "outputs"
QUEUE = BASE / "data" / "review_queue.csv"
...
flags = pd.read_csv(OUT / "signals.csv", dtype=str, keep_default_na=False, low_memory=False)
...
}).to_csv(OUT / "summary.csv", index=False, encoding="utf-8-sig")
